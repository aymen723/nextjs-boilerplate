      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
Passionate and adaptable software engineer, 
adept at crafting scalable and innovative web and mobile applications.
 Proficient in an array of technologies including React Native, React, Java, Spring Boot, SQL, NoSQL, and DevOps methodologies. 
 With a fervent commitment to mastering new skills and technologies, 
 I thrive in dynamic environments where I can continually push the boundaries of my expertise. 
 Equipped with a strong foundation in both frontend and backend development, 
 I am dedicated to delivering top-notch software solutions that exceed user and business expectations. 
            </p>
            {/* BIOGRAPHY QUOTE */}
